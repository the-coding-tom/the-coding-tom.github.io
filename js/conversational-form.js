            ...
            (e.prototype.animateElementsIn = function () {
                ...
                this.elements.length > 0 &&
                    (this.resize(),
                        ...
                        setTimeout(function () {
                            t.list.style.height = "auto";
                            var e = t.getElements();
                            setTimeout(function () {
                                if (e.length > 0) {
                                    t.el.classList.contains("animate-in") ||
                                        t.el.classList.add("animate-in");
                                    for (var n = 0; n < e.length; n++) {
                                        e[n].animateIn();
                                    }
                                }
                                document
                                    .querySelector(".scrollableInner")
    ...
    var e = (function () {
        ...
        return (
            ...
            (e.prototype.render = function () {
                ...
                this.xTarget > 0 &&
                    (this.xTarget +=
                        (0 - this.xTarget) * t.Helpers.lerp(e.acceleration, 0.3, 0.8)),
                    this.xTarget < this.max &&
                    (this.xTarget +=
                        (this.max - this.xTarget) *
                        t.Helpers.lerp(e.acceleration, 0.3, 0.8)),
    ...
    var e = (function () {
        function e(t) {
            ...
            t &&
                ...
                t.userImage ?
                (this.data["user-image"] = t.userImage) :
                (this.data["user-image"] = this.data["user-image"]),
                t.robotImage ?
                (this.robotData["robot-image"] = t.robotImage) :
        ...
        function e(e) {
            if (
                ((this.domElement = e.domElement),
                    ...
                    e.questions && (this.questions = e.questions),
        ...
        return (
            ...
            Object.defineProperty(e.prototype, "question", {
                get: function () {
                    return this.questions && 0 != this.questions.length ?
                        ...
                        t.Dictionary.getRobotResponse(this.type);
                },
                enumerable: !0,
                configurable: !0,
            }),
                ...
                get: function () {
                    return (
                        ...
                        (this.domElement.getAttribute("cf-error") ?
                            (this.errorMessages = t.Helpers.getValuesOfBars(
                                this.domElement.getAttribute("cf-error")
                            )) :
                            ...
                            this.required ?
                            (this.errorMessages = [
                                t.Dictionary.get("input-placeholder-required"),
                            ]) :
                            "file" == this.type ?
                            (this.errorMessages = [
                                t.Dictionary.get("input-placeholder-file-error"),
                            ]) :
                            (this.errorMessages = [
                                t.Dictionary.get("input-placeholder-error"),
                            ])),
                        this.errorMessages[
            ...
            (e.createTag = function (n) {
                if (e.isTagValid(n)) {
                    ...
                    return (
                        ...
                        "cf-robot-message" == n.tagName.toLowerCase() &&
                        (i = new t.CfRobotMessageTag({
                            domElement: n
                        })),
                        i
                    );
            ...
            (e.prototype.setTagValueAndIsValid = function (t) {
                ...
                this.domElement.hasAttribute("type") &&
                    "email" === this.domElement.getAttribute("type") &&
                    !this.pattern &&
                    n.length > 0 ?
                ...
                return (
                    -1 != i && n.length < i && (e = !1),
                    -1 != o && n.length > o && (e = !1),
                    this.validateMaxMinValue(n) || (e = !1),
            ...
            (e.prototype.getLabel = function () {
                return (
                    ...
                    this._label ? this._label : t.Dictionary.getRobotResponse(this.type)
                );
            }),
            ...
            (e.prototype.findAndSetQuestions = function () {
                if (!this.questions) {
                    if (this.domElement.getAttribute("cf-questions"))
                        ...
                        (this.questions = t.Helpers.getValuesOfBars(
                            e.getAttribute("cf-questions")
                        )),
                        e.getAttribute("cf-input-placeholder") &&
                            (this._inputPlaceholder = e.getAttribute(
                                "cf-input-placeholder"
                            ));
                    } else {
                    ...
                    if (e) {
                        ...
                        if (0 == n.length) {
                            ...
                            for (var o = 0; o < n.length; o++) {
                                var s = n[o];
                                s.getAttribute("for") == this.id &&
                                    (this._label = t.Helpers.getInnerTextOfElement(s));
                            }!this._label &&
                            n[0] &&
                            (this._label = t.Helpers.getInnerTextOfElement(n[0]));
                    }
                }
            }),
            (e.prototype.onDomElementChange = function () {
                this._eventTarget.dispatchEvent(
                    new CustomEvent(t.TagEvents.ORIGINAL_ELEMENT_CHANGED, {
                        detail: {
                            value: this.value,
                            tag: this
                        },
    ...
    var e = (function () {
        ...
        return (
            ...
            Object.defineProperty(e.prototype, "errorMessage", {
                get: function () {
                    for (
                        var e = t.Dictionary.get("input-placeholder-error"), n = 0; n < this.elements.length; n++
                    ) {
...
!(function (t) {
    var e = (function (e) {
        function n(n) {
            ...
            i.optionTags = [];
            for (
                var o = i.domElement.getElementsByTagName("option"), s = 0; s < o.length; s++
            ) {
                var r = o[s],
                    a = t.Tag.createTag(r);
                a
            ...
            (n.prototype.setTagValueAndIsValid = function (t) {
                ...
                if (((this._values = []), t.controlElements))
                    for (var i = 0; i < this.optionTags.length; i++)
                        for (
                            var o = this.optionTags[i], s = 0; s < t.controlElements.length; s++
                        ) {
                            var r = t.controlElements[s];
                            r.referenceTag == o &&
        ...
        return (
            ...
            (n.prototype.onClick = function (e) {
                t.ConversationalForm.illustrateFlow(
                    ...
                    this.eventTarget.dispatchEvent(
                        new CustomEvent(t.OptionButtonEvents.CLICK, {
                            detail: this
                        })
                    );
            }),
            ...
            (n.prototype.onDomElementChange = function (e) {
                ...
                (i.onloadstart = function (e) {
                    ...
                    if (s > n.maxFileSize) {
                        i.abort();
                        var r = {
                            errorText: t.Dictionary.get(
                                "input-placeholder-file-size-error"
                            ),
                        };
                        t.ConversationalForm.illustrateFlow(
                                n,
                    ...
                    (this.promise = new Promise(function (t, e) {
                        ...
                        .then(function (e) {
                            ...
                            t.ConversationalForm.illustrateFlow(
                                ...
                                n.eventTarget.dispatchEvent(
                                    new CustomEvent(t.UserInputEvents.SUBMIT, {
                                        detail: i
                                    })
                                );
                        })
    ...
    var e = (function (e) {
        function n(n) {
            ...
            return (
                ...
                t.ConversationalForm.animationsEnabled ||
                i.inputElement.setAttribute("no-animations", ""),
                ...
                i.el.querySelector("div").appendChild(i.submitButton.el),
        ...
        return (
            ...
            (n.prototype.resetInputHeight = function () {
                "1" === this.inputElement.getAttribute("rows") ?
            ...
            (n.prototype.checkForCorrectInputTag = function () {
                ...
                if (
                    ...
                    Array.prototype.slice
                        ...
                        "password" === this.inputElement.type &&
                        e.setAttribute("autocomplete", "new-password"),
                        this._currentTag.domElement.hasAttribute("autocomplete") &&
                        e.setAttribute(
                            "autocomplete",
                            this._currentTag.domElement.getAttribute("autocomplete")
                        ),
                        this._currentTag.domElement.hasAttribute("list") &&
                        e.setAttribute(
                            "list",
                            this._currentTag.domElement.getAttribute("list")
                        ),
                        this.inputElement.parentNode.replaceChild(e, this.inputElement),
                        (this.inputElement = e);
                    ...
                    Array.prototype.slice
                        ...
                        this.inputElement.parentNode.replaceChild(n, this.inputElement),
                        (this.inputElement = n);
                }
                this.inputElement &&
                    this.inputElement.tagName !== t &&
            ...
            (n.prototype.removeAttribute = function (t) {
                this.inputElement &&
                    this.inputElement.hasAttribute(t) &&
                    this.inputElement.removeAttribute(t);
            }),
            (n.prototype.tagType = function (t) {
                return t.domElement && t.domElement.tagName ?
                    "TEXTAREA" === t.domElement.tagName ||
                    (t.domElement.hasAttribute("rows") &&
                        parseInt(t.domElement.getAttribute("rows"), 10) > 1) ?
                    "TEXTAREA" :
                    "INPUT" === t.domElement.tagName ?
                    "INPUT" :
                    "TEXTAREA" :
                    "TEXTAREA";
            }),
    ...
    var e = (function (e) {
        ...
        return (
            ...
            Object.defineProperty(n.prototype, "added", {
                get: function () {
                    return (
                        !!this.el || !!this.el.parentNode || !!this.el.parentNode.parentNode
                    );
                },
                enumerable: !0,
                configurable: !0,
            ...
            (n.prototype.hasFlexBug = function () {
                return (
            ...
            (n.prototype.animateIn = function () {
                ...
                this.hasFlexBug() && n.classList.remove("scroll"),
                    requestAnimationFrame(function () {
                        var i = t.el.scrollHeight;
                        (t.el.style.height = "0px"),
                        requestAnimationFrame(function () {
                            (t.el.style.height = i + "px"), t.el.classList.add("show");
                            try {
                                var o = window.getComputedStyle(
                                        document.querySelectorAll("p.show")[0]
                                    ),
                    ...
                    if (
                        ...
                        if (0 === l) {
                            for (var u = 0; u < c.length; u++) {
                                var h = c[u];
                                this.textEl.innerHTML += "<p>" + h + "</p>";
                            }
                            for (var p = this, d = 0; d < c.length; d++)
                                !(function (e) {
                                    setTimeout(
                                        function () {
                                            t.tryClearThinking(),
                                                t.textEl
                                                .getElementsByTagName("p")[e].classList.add("show"),
                                                t.scrollTo();
                                        },
                                        c.length > 1 && e > 0 ?
                                        l + (e + 1) * p.uiOptions.robot.chainedResponseTime :
                                        0
                                    );
                                })(d);
                        } else
                            for (var f = this, m = 0; m < c.length; m++)
                                !(function (e) {
                                    var n = l + e * f.uiOptions.robot.chainedResponseTime,
                                        i = c[e];
                                    setTimeout(function () {
                                        t.tryClearThinking(),
                                            (t.textEl.innerHTML += "<p>" + i + "</p>"),
                                            t.textEl
                                            .getElementsByTagName("p")[e].classList.add("show"),
                                            t.scrollTo();
                                    }, n);
                        ...
                        var g = e.indexOf("<img") > -1,
                            v = new RegExp("<img[^>]*?>", "g"),
                            b = e.match(v);
                        g && b ?
                            ((e = e.replace(b[0], "")),
                                (this.textEl.innerHTML =
                                    '<p class="hasImage">' + b + "<span>" + e + "</span></p>")) :
                            (this.textEl.innerHTML = "<p>" + e + "</p>");
                        var E = this.textEl.getElementsByTagName("p");
                        E[E.length - 1].offsetWidth,
                            E[E.length - 1].classList.add("show"),
                            this.scrollTo();
                    }
                    (this.parsedResponse = e),
                    this.uiOptions.robot && 0 === this.uiOptions.robot.robotResponseTime ?
                        this.addSelf() :
                        setTimeout(function () {
                            t.addSelf();
                        }, 0),
            ...
            (n.prototype.scrollTo = function () {
                ...
                !this.container && this.el && (this.container = this.el),
                    ...
                    (this.container.parentElement.scrollTop =
                        t + e + this.container.parentElement.scrollHeight);
            }),
            ...
            (n.prototype.addSelf = function () {
                this.el.parentNode != this.container &&
                    (this.container.appendChild(this.el), this.animateIn());
            }),
            (n.prototype.onClick = function (e) {
                this.setToThinking(),
                    t.ConversationalForm.illustrateFlow(
        ...
        return (
            ...
            (n.prototype.onInputElementChanged = function () {
                if (this.cfReference && this.cfReference.el) {
                    this.cfReference.el.offsetHeight, this.input.height;
                }
            }),
            (n.prototype.onFlowUpdate = function (e) {
                var n = this;
            ...
            (n.prototype.onListUpdate = function (e) {
                ...
                clearTimeout(this.updateTimer),
                    (this.updateTimer = setTimeout(function () {
                        n.eventTarget.dispatchEvent(
                                new CustomEvent(t.ChatListEvents.CHATLIST_UPDATED, {
                                    detail: n
                                })
                            ),
                            e.show();
        ...
        return (
            ...
            (e.prototype.editTag = function (t) {
                if (
                    ...
                    for (
                        var e = this.tags.indexOf(t), n = e + 1; n < this.tags.length; n++
                    ) {
                        this.tags[n].reset();
                    }
                }
            ...
            (e.prototype.validateStepAndUpdate = function () {
                this.maxSteps > 0 &&
                    (this.step == this.maxSteps ?
                        (this.eventTarget.dispatchEvent(
                                new CustomEvent(t.FlowEvents.FORM_SUBMIT, {})
                            ),
        ...
        function e(n) {
            if (
                ((this.version = "1.0.1"),
                    ...
                    "boolean" == typeof n.suppressLog && (e.suppressLog = n.suppressLog),
                    "boolean" == typeof n.showProgressBar &&
                    (e.showProgressBar = n.showProgressBar),
                    "boolean" == typeof n.preventSubmitOnEnter &&
                    (this.preventSubmitOnEnter = n.preventSubmitOnEnter),
                    e.suppressLog ||
                    console.log("Conversational Form > version:", this.version),
                    e.suppressLog || console.log("Conversational Form > options:", n),
                    (window.ConversationalForm[this.createId] = this),
                    n.eventDispatcher && (this._eventTarget = n.eventDispatcher),
                    this.eventTarget.cf || (this.eventTarget.cf = this),
                    n.flowStepCallback && (this.flowStepCallback = n.flowStepCallback),
                    (this.isDevelopment = e.illustrateAppFlow = !!document.getElementById(
                        "conversational-form-development"
                    )),
                    0 == n.loadExternalStyleSheet && (this.loadExternalStyleSheet = !1),
                    "string" == typeof n.theme && (this.theme = n.theme),
                    isNaN(n.scrollAcceleration) ||
                    (t.ScrollController.acceleration = n.scrollAcceleration),
                    (this.preventAutoStart = n.preventAutoStart),
                    (this.preventAutoAppend = n.preventAutoAppend),
                    !n.formEl)
            )
                throw new Error(
            ...
            if (
                ((this.formEl = n.formEl),
                    this.formEl.setAttribute("cf-create-id", this.createId),
                    !0 === n.hideUserInputOnNoneTextInput &&
                    (t.UserInputElement.hideUserInputOnNoneTextInput = !0),
                    (this.submitCallback = n.submitCallback),
                    this.submitCallback && "string" == typeof this.submitCallback)
            ) {
                var i = window[this.submitCallback];
                this.submitCallback = i;
            }
            "" == this.formEl.getAttribute("cf-no-animation") &&
                (e.animationsEnabled = !1),
                "boolean" == typeof n.animationsEnabled &&
                !1 === n.animationsEnabled &&
                ((e.animationsEnabled = !1),
                    this.formEl.setAttribute("cf-no-animation", "")),
                (n.preventAutoFocus ||
                    "" == this.formEl.getAttribute("cf-prevent-autofocus")) &&
                (t.UserInputElement.preventAutoFocus = !0),
                (this.dictionary = new t.Dictionary({
                ...
                (this.context = n.context ? n.context : document.body),
                (this.tags = n.tags),
                n.microphoneInput &&
                ((n.microphoneInput.init && n.microphoneInput.input) ||
                    (console.warn(
                            "Conversational Form: microphoneInput is not correctly setup",
                            n.microphoneInput
                        ),
                        (n.microphoneInput = null))),
                (this.microphoneInputObj = n.microphoneInput),
                (this.uiOptions = t.Helpers.extendObject(
                    t.UserInterfaceDefaultOptions,
                    n.userInterfaceOptions || {}
                )),
                this.init();
        }
        return (
            Object.defineProperty(e.prototype, "createId", {
                get: function () {
                    return (
                        this._createId ||
            ...
            Object.defineProperty(e.prototype, "eventTarget", {
                get: function () {
                    return (
                        this._eventTarget ||
                        (this._eventTarget = new t.EventDispatcher(this)),
                        this._eventTarget
                    );
                },
                enumerable: !0,
            ...
            (e.prototype.init = function () {
                ...
                if (
                    (-1 == ["fixed", "absolute", "relative"].indexOf(
                            window
            ...
            (e.prototype.updateDictionaryValue = function (e, n, i) {
                t.Dictionary.set(e, n, i),
                    -1 != ["robot-image", "user-image"].indexOf(e) &&
                    this.chatList.updateThumbnail("robot-image" == e, i);
            }),
            ...
            (e.prototype.start = function () {
                ...
                e.suppressLog || console.log("option, disabled 3"),
            ...
            (e.prototype.setupTagGroups = function (e) {
                for (var n = [], i = 0; i < e.length; i++) {
                    ...
                    (n[o.name] || (n[o.name] = []), n[o.name].push(o));
                }
                if (Object.keys(n).length > 0)
                    for (var s in n)
                        if (n[s].length > 0) {
                            ...
                            r &&
                                "fieldset" !== r.tagName.toLowerCase() &&
                                ((r = r.parentNode),
                                    (function (t) {
                                        return (
                                            t &&
            ...
            (e.prototype.setupUI = function () {
                ...
                if (
                    ((n.className = "conversational-form-inner"),
                        this.el.appendChild(n),
                        (this.chatList = new t.ChatList({
                            eventTarget: this.eventTarget,
                            cfReference: this,
                        })),
                        n.appendChild(this.chatList.el),
                        (this.userInput = new t.UserTextInput({
                ...
                this.chatList.addInput(this.userInput),
                    n.appendChild(this.userInput.el),
            ...
            (e.prototype.addBrowserTypes = function (t) {
                navigator.userAgent.indexOf("Firefox") > -1 &&
                    t.classList.add("browser-firefox"),
                    /Edge/.test(navigator.userAgent) && t.classList.add("browser-edge");
            }),
            (e.prototype.addTags = function (e, n, i) {
                ...
                for (var o = [], s = 0; s < e.length; s++) {
                    ...
                    if ("fieldset" === r.tag)
                        for (
                            var a = t.TagsParser.parseGroupTag(r), l = 0; l < a.children.length; l++
                        ) {
                            var c = a.children[l];
                            if (t.Tag.isTagValid(c)) {
                                var u = t.Tag.createTag(c);
                                u.name || (u.name = "tag-ref-" + l.toString()), o.push(u);
                            }
                        }
                    else {
                        var c =
                            "select" === r.tag ?
                            t.TagsParser.parseGroupTag(r) :
                            t.TagsParser.parseTag(r);
                        if (t.Tag.isTagValid(c)) {
                            var u = t.Tag.createTag(c);
                            o.push(u);
                        }
                ...
                (o = this.setupTagGroups(o)),
                (this.tags = this.flowManager.addTags(
                    o,
                    n ? this.flowManager.getStep() + 1 : i
                ));
            }),
            ...
            (e.illustrateFlow = function (t, n, i, o) {
                if ((void 0 === o && (o = null), e.illustrateAppFlow)) {
                    ...
                    e.suppressLog ||
                        ...
                        o && (e.suppressLog || console.log("** event flow detail:", o));
                }
            }),
            ...
            (e.animationsEnabled = !0),
            (e.illustrateAppFlow = !0),
            (e.suppressLog = !0),
            (e.showProgressBar = !1),
            (e.preventSubmitOnEnter = !1),
            (e.hasAutoInstantiated = !1),
            e
        );
    })();
